...
<head>
  ...
  <title>Ventas 360° | Telas Real</title>
  ...
  <script>
    function toggleFullScreen() {
        ...
        if (iframe.requestFullscreen) {
            ...
            iframe.classList.toggle('rounded-xl');
        }
    }
  </script>
</head>
<body class="bg-deep-bg text-slate-300 font-sans antialiased overflow-x-hidden selection:bg-core-blue selection:text-white flex flex-col min-h-screen">
  ...
  <main class="relative z-10 pt-24 pb-12 flex-grow w-full">
    <div class="mx-auto w-full max-w-[1920px] px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
                 ...
                 <h1 class="text-2xl font-heading font-bold text-white">Ventas 360°</h1>
            </div>
            <div class="flex gap-2">
                <button type="button" onclick="toggleFullScreen()" class="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-xs text-slate-300 border border-white/10 transition-colors flex items-center gap-2">
        ...
        <div id="dashboard-container" class="glass-card p-1 rounded-2xl transition-all duration-300 w-full">
             <iframe
               id="dashboard-frame"
               title="BI Ventas TR"
